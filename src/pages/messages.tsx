...
let titles = [
  ["Rust", "Le choix écoloqiue : moins de serveurs, plus de sécurité"],
  [
    "Vue et Nuxt",
    "Vue a été créé par Evan You, le créateur de Nuxt. C'est un choix évident.",
  ],
  ["Next.js", "Le meilleur framework React"],
  ["SolidStart.js", "Signals, ce l'avenir."],
  ["Remix", "Edge subroutines et autres choses inventées par nous"],
  ["Svelte!", "C'est fun, c'est rapide, c'est Svelte!"],
];
